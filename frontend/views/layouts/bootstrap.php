...
<header class="masthead bg-primary text-white text-center">
    <div class="container d-flex align-items-center flex-column">
        ...
        <img class="masthead-avatar mb-5" src="assets/img/tank.svg" alt="..."/>
        <!-- Masthead Heading-->
        <h1 class="masthead-heading text-uppercase mb-0">Blog o czołgach</h1>
        <!-- Icon Divider-->
        ...
        <!-- Masthead Subheading-->
        <p class="masthead-subheading font-weight-light mb-0">Historia - Twórcy - Specyfikacja - Debaty</p>
    </div>
</header>
<?= $content ?>
<!-- Portfolio Section-->
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 mb-5 mb-lg-0">
                <h4 class="text-uppercase mb-4">Miejsce</h4>
                <p class="lead mb-0">
                    Cały świat
                </p>
            </div>
            <!-- Footer Social Icons-->
            <div class="col-lg-4 mb-5 mb-lg-0">
                <h4 class="text-uppercase mb-4">Nasze media społecznościowe</h4>
            ...
            <!-- Footer About Text-->
            <div class="col-lg-4">
                <h4 class="text-uppercase mb-4">Czołg miesiąca</h4>
                <p class="lead mb-0">
...
<div class="copyright py-4 text-center text-white">
    <div class="container"><small>Copyright &copy; Blogtank 2022</small></div>
</div>
<!-- Portfolio Modals-->
<!-- Portfolio Modal 1-->
